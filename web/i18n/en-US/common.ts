const translation = {
  ...
  account: {
    ...
    profileEditDescription: 'Manage your personal information and account settings',
    nickname: 'Nickname',
    nicknameTip: 'Your display name visible to others',
    nicknamePlaceholder: 'Enter your nickname',
    nicknameEmpty: 'Nickname cannot be empty',
    editNickname: 'Edit Nickname',
    phoneNumber: 'Phone Number',
    phoneNumberTip: 'Your phone number for security verification',
    phoneNumberNotSet: 'Not set',
    changePhone: 'Change Phone',
    bindPhone: 'Bind Phone',
    realName: 'Real Name',
    realNameTip: 'Your real name for identity verification',
    realNameNotSet: 'Not set',
    setRealName: 'Set Real Name',
    verifyRealName: 'Verify Real Name',
    verified: 'Verified',
    // Avatar management
    avatarTip: 'JPG, GIF or PNG. 5MB max.',
    uploadAvatar: 'Upload',
    editAvatar: 'Edit',
    selectImage: 'Select Image',
    imageFormat: 'JPG, PNG, GIF (5MB max)',
    invalidImageFormat: 'Invalid image format. Please select JPG, PNG, or GIF.',
    imageTooLarge: 'Image too large. Maximum size is 5MB.',
    cropInstruction: 'The image will be automatically cropped to a circle',
    cropImage: 'Crop Image',
    avatarPreview: 'Preview your new avatar',
    avatarUpdated: 'Avatar updated',
    // Phone management
    verifyCurrentPhone: 'Verify Current Phone',
    verifyCurrentPhoneDesc: 'We\'ll send a verification code to {{phone}}',
    setNewPhone: 'Set New Phone Number',
    setNewPhoneDesc: 'Enter your new phone number',
    newPhoneNumber: 'New Phone Number',
    verifyNewPhone: 'Verify New Phone',
    verifyNewPhoneDesc: 'We\'ll send a verification code to {{phone}}',
    phoneChangeSuccess: 'Phone Changed Successfully',
    phoneBindSuccess: 'Phone Bound Successfully',
    phoneChangeSuccessDesc: 'Your phone number has been updated to {{phone}}',
    // Security audit
    securityAudit: 'Security & Audit',
    securityAuditTip: 'View your profile modification history for security review',
    viewProfileHistory: 'View History',
    profileHistory: 'Profile History',
    profileHistoryDesc: 'Track all changes to your profile information',
    noProfileHistory: 'No modification history found',
    oldValue: 'Old Value',
    newValue: 'New Value',
    location: 'Location',
